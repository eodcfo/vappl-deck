...
def deck_ggv():
    ...
    sp = M["company"]["profile"]["subhash_park"]
    cw = f["cash_waterfall"]
    S = []
...
{note("blue","Sources and reproducibility",
  ...
  "Musical Fountains and Snack Counter Facilities at Geeta Govind Vatika. Company figures — the Agra cluster "
  "overhead basis and the group margin target — are from the FY25-26 provisional accounts and the company "
  "financial model. The Subhash Park revenue in section 03 is management's reported position for FY26-27 to "
  "date, not a modelled figure, and runs ahead of what the company financial model carries for that year. "
  "CGTMSE parameters reflect the position published after the April 2025 revisions.<br><br>Every number here is generated by <b>model/pf_model.py</b> and rendered by "
